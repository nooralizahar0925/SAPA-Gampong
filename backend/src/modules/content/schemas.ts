...
export const VillageProfileResponse = registry.register(
  ...
  z.object({
    ...
    kemukiman: z.string().nullable(),
    area_size: z.string().nullable(),
...
export const UpdateVillageProfileBody = registry.register(
  ...
  z.object({
    ...
    kemukiman: z.string().max(120).nullish(),
    area_size: z.string().max(60).nullish(),
    elevation: z.string().max(60).nullish(),
